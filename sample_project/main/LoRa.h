...
#define LORA_DEFAULT_HANDLE()                                                  \
    {                                                                          \
        .DIO0_pin = -1, .reset_pin = -1, .CS_pin = -1, .spi_host = SPI1_HOST,  \
        .frequency = 433, .spredingFactor = SF_7, .bandWidth = BW_125KHz,      \
        .crcRate = CR_4_5, .power = POWER_20db, .overCurrentProtection = 100,  \
        .preamble = 8,                                                         \
    }
